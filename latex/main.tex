...
\begin{enumerate}
	\item Describing circuits
	\item 2nd order system model: matrices + input signals
	\item 1st order: matrices + output signal
\end{enumerate}
...
\begin{equation*}
	...
	\textbf{.}
\end{equation*}
The multipliers of the scaling $a\cdot b$ are listed in Table \ref{table:triangular_matrix_values}, e.g. we have a scaling $\frac{L}{R}$ of matrix $M$ for a ladder with resistor as shunt.
