...
\begin{figure*}[t!]
	\centering
	\subfloat[Input Signals]{\includegraphics[width=0.47\columnwidth]{images/input_signal}}
	\hfill
	\subfloat[Capacitor]{\includegraphics[width=0.47\columnwidth]{images/lines_shunt_capacitor}}
	
	\subfloat[Resistor]{\includegraphics[width=0.47\columnwidth]{images/lines_shunt_resistor}}
	\hfill
	\subfloat[Inductor]{\includegraphics[width=0.47\columnwidth]{images/lines_shunt_inductor}}
